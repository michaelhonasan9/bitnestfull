...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('referred_id', 'Referred*', ['class' => 'control-label']) !!}
                    {!! Form::select('referred_id', $referreds, old('referred_id'), ['class' => 'form-control select2', 'required' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('referred_id'))
                        <p class="help-block">
                            {{ $errors->first('referred_id') }}
                        </p>
                    @endif
                </div>
            </div>
